<style>
    ...
    *::after {
    ...
    .form-control:focus {
        ...
        border-color: #02eb7f;
        outline: 0;
        box-shadow: 0 0 0 0.2rem rgba(1, 109, 59, 0.25);
    }
    ...
    .valid-tooltip {
        ...
        line-height: 1.5;
        color: #fff;
        background-color: rgba(1, 160, 86, 0.9);
        border-radius: 0.35rem;
    }
    ...
    .form-control.is-valid {
        ...
        background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='8' height='8' viewBox='0 0 8 8'%3e%3cpath fill='%2301a056' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
    ...
    .form-control.is-valid:focus {
        border-color: #01a056;
        box-shadow: 0 0 0 0.2rem rgba(1, 160, 86, 0.25);
    }
    ...
    .custom-select.is-valid {
        ...
        background: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='4' height='5' viewBox='0 0 4 5'%3e%3cpath fill='%235a5c69' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e")
            ...
            #fff
                url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='8' height='8' viewBox='0 0 8 8'%3e%3cpath fill='%2301a056' d='M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e")
    ...
    .btn-primary.focus {
        ...
        background-color: #014726;
        border-color: #013a20;
        box-shadow: 0 0 0 0.2rem rgba(39, 131, 88, 0.5);
    }
    ...
    .btn-secondary.focus {
        ...
        background-color: #1d104f;
        border-color: #190e44;
        box-shadow: 0 0 0 0.2rem rgba(73, 57, 133, 0.5);
    }
    ...
    .btn-success.focus {
        ...
        background-color: #017a42;
        border-color: #016d3b;
        box-shadow: 0 0 0 0.2rem rgba(39, 174, 111, 0.5);
    }
    ...
    .btn-warning.focus {
        ...
        background-color: #d9d000;
        border-color: #ccc400;
        box-shadow: 0 0 0 0.2rem rgba(225, 217, 10, 0.5);
    }
    ...
    .btn-outline-primary.focus {
        box-shadow: 0 0 0 0.2rem rgba(1, 109, 59, 0.5);
    }
    ...
    .btn-outline-secondary.focus {
        box-shadow: 0 0 0 0.2rem rgba(41, 22, 111, 0.5);
    }
    ...
    .btn-outline-success.focus {
        box-shadow: 0 0 0 0.2rem rgba(1, 160, 86, 0.5);
    }
    ...
    .custom-checkbox
        ...
        ~ .custom-control-label::before {
        background-color: rgba(1, 109, 59, 0.5);
    }
    .custom-checkbox
    ...
    .custom-range:focus::-webkit-slider-thumb {
        box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(1, 109, 59, 0.25);
    }
    ...
    .bg-success {
        background-color: #01a056 !important;
    }
    ...
    .text-success {
        color: #01a056 !important;
    }

    a.text-success:hover,
    a.text-success:focus {
        color: #01542d !important;
    }
    ...
    .bg-gradient-primary {
        background-color: #016d3b;
        background-image: linear-gradient(180deg, #016d3b 10%, #002112 100%);
        background-size: cover;
    }

    .bg-gradient-secondary {
        background-color: #29166f;
        background-image: linear-gradient(180deg, #29166f 10%, #11092f 100%);
        background-size: cover;
    }

    .bg-gradient-success {
        background-color: #01a056;
        background-image: linear-gradient(180deg, #01a056 10%, #01542d 100%);
        background-size: cover;
    }
    ...
    .bg-gradient-warning {
        background-color: #fff500;
        background-image: linear-gradient(180deg, #fff500 10%, #b3ac00 100%);
        background-size: cover;
    }
    ...
    .border-left-primary {
        border-left: 0.25rem solid #016d3b !important;
    }

    .border-bottom-primary {
        border-bottom: 0.25rem solid #016d3b !important;
    }

    .border-left-secondary {
        border-left: 0.25rem solid #29166f !important;
    }

    .border-bottom-secondary {
        border-bottom: 0.25rem solid #29166f !important;
    }

    .border-left-success {
        border-left: 0.25rem solid #01a056 !important;
    }

    .border-bottom-success {
        border-bottom: 0.25rem solid #01a056 !important;
    }
    ...
    .border-left-warning {
        border-left: 0.25rem solid #fff500 !important;
    }

    .border-bottom-warning {
        border-bottom: 0.25rem solid #fff500 !important;
    }
